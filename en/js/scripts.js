...
jQuery(document).ready(function ($) {
  ...
  function loadHeader() {
    return $.Deferred(function (deferred) {
      $("#header-placeholder").load("/en/header.html", function () {
        deferred.resolve();
      });
    }).promise();
  }
  ...
  function loadOverlays() {
    return $.Deferred(function (deferred) {
      $("#overlays-placeholder").load("/en/overlays.html", function () {
        deferred.resolve();
      });
    }).promise();
  }
  ...
  function loadSidebar() {
    return $.Deferred(function (deferred) {
      $("#sidebar-placeholder").load("/en/sidebar.html", function () {
        deferred.resolve();
      });
    }).promise();
  }
  ...
  function loadWidgets() {
    return $.Deferred(function (deferred) {
      $("#widgets-placeholder").load("/en/widgets.html", function () {
        deferred.resolve();
      });
    }).promise();
  }
  ...
  function loadCarousel() {
    return $.Deferred(function (deferred) {
      $("#carousel-placeholder").load("/en/carousel.html", function () {
  ...
  function initializeBlogFeed() {
    return $.Deferred(function (deferred) {
      ...
      $.when(
        fetchJson("/en/articles.json"),
        fetchJson("/en/tags.json")
      ).done(function (articlesResponse, tagsResponse) {
        ...
        if (Array.isArray(articles) && articles.length > 0) {
          ...
          renderPosts(articles, tags, 1); // Pass the loaded tags
          ...
          $("#pagination").on("click", ".page-numbers", function (e) {
            ...
            renderPosts(articles, tags, pageNumber);
            $("html, body").animate(
